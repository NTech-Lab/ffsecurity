...
* Оператор. Обладает правами на :ref:`создание досье вручную <create-dossier-operator>`, подтверждение событий и поиск лиц в базе событий и базе досье. Остальная информация доступна в режиме чтения. :ref:`Пакетное <batch-upload>` создание досье невозможно.
* Пользователь. Обладает правами только на подтверждение событий и поиск лиц в базе событий и базе досье. Остальная информация доступна в режиме чтения.
