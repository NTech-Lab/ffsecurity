...
.. note::
   Документ доступен по адресу http://docs.findface.pro/projects/ffsecurity/ru/1.1-windows/index.html и во встроенном фреймворке ``http://<ffsecurity_ip>/doc/`` (после установки).
