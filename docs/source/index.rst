...
.. note::
   Документ доступен по адресу http://docs.findface.pro (выберите нужную версию) и во встроенном фреймворке ``http://<ffsecurity_ip>/doc/ru/index.html`` (после установки).
