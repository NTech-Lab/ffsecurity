...
Просмотр логов в ОС Windows
--------------------------------

Для того чтобы просмотреть логи в ОС Windows, перейдите в :menuselection:`Menu Start --> FindFace Security --> Logs Monitor`.
